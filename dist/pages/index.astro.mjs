/* empty css                                  */
import { c as createComponent, m as maybeRenderHead, d as renderScript, b as addAttribute, a as renderTemplate, r as renderComponent } from '../chunks/astro/server_Wi9KjUbP.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
}, "C:/Users/shahb/OneDrive/Desktop/display-main/display-main/src/components/NewProducts.astro", void 0);
...
}, "C:/Users/shahb/OneDrive/Desktop/display-main/display-main/src/components/NewsAndEvents.astro", void 0);
...
<svg class="w-5 h-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path> </svg> </a> </div> </div> </section> ${renderScript($$result, "C:/Users/shahb/OneDrive/Desktop/display-main/display-main/src/components/FAQS.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/shahb/OneDrive/Desktop/display-main/display-main/src/components/FAQS.astro", void 0);
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Smart Boards & Interactive Panels in Dubai | LED & LCD Displays | CCTV Monitors | Lovosis Display", "description": "Dubai's leading distributor of Smart Boards, Interactive Panels, CCTV Monitors and Keyboards. Premium LED & LCD display solutions with installation across Dubai and UAE. Call +971 50 916 2488 for consultation.", "keywords": keywords, "sd": homepageSchema, "siteName": "Lovosis Display Dubai", "site": "https://unv-ledmodules.com", "image": {
    url: "/images/homepage-hero.jpg",
    alt: "Smart Boards and Interactive Panels in Dubai - Lovosis Display Solutions"
  }, "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="hero-section" data-astro-cid-j7pv25f6> <h1 class="visually-hidden" data-astro-cid-j7pv25f6>Smart Boards and Interactive Panels in Dubai - Premium Display Solutions</h1> ${renderComponent($$result2, "Carousel", $$Carousel, { "data-astro-cid-j7pv25f6": true })} </section> <section id="featured-products" class="featured-section" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> <h2 class="section-title" data-astro-cid-j7pv25f6>Featured Display Solutions in Dubai</h2> <p class="section-description" data-astro-cid-j7pv25f6>Discover our premium Smart Boards, Interactive Panels, CCTV Monitors and Keyboards available across Dubai and UAE.</p> ${renderComponent($$result2, "NewProducts", $$NewProducts, { "data-astro-cid-j7pv25f6": true })} </div> </section> <section id="faqs" class="faq-section" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> <h2 class="section-title" data-astro-cid-j7pv25f6>Frequently Asked Questions</h2> <p class="section-description" data-astro-cid-j7pv25f6>Get answers to common questions about our Smart Boards, Interactive Panels, and other display solutions available in Dubai.</p> ${renderComponent($$result2, "FAQS", $$FAQS, { "data-astro-cid-j7pv25f6": true })} </div> </section> <section id="news" class="news-section" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "NewsAndEvents", $$NewsAndEvents, { "data-astro-cid-j7pv25f6": true })} </div> </section> <section id="partners" class="partners-section" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> <h2 class="section-title" data-astro-cid-j7pv25f6>Our Partners in Dubai</h2> <p class="section-description" data-astro-cid-j7pv25f6>Working with Dubai's top businesses and educational institutions</p> ${renderComponent($$result2, "LogoCloud", $$LogoCloud, { "data-astro-cid-j7pv25f6": true })} </div> </section> ` })} `;
}, "C:/Users/shahb/OneDrive/Desktop/display-main/display-main/src/pages/index.astro", void 0);

const $$file = "C:/Users/shahb/OneDrive/Desktop/display-main/display-main/src/pages/index.astro";
const $$url = "";
